const ITEMS = [
    {
        title: "Empieza desde cero sin sentirte perdido",
        desc: "Entenderás qué es cripto, cómo funciona un exchange y qué revisar antes de tu primera compra u operación.",
        iconPath: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25",
    },
    {
        title: "Lee el mercado antes de apretar comprar",
        desc: "Conoce lo básico de análisis técnico y contexto de mercado para no entrar solo por emoción, FOMO o recomendaciones de terceros.",
        iconPath: "M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z",
    },
    {
        title: "Protege tu capital desde el día uno",
        desc: "Aprende a pensar en tamaño de posición, pérdida máxima y escenarios antes de buscar rentabilidad.",
    ...
    {
        title: "Elige tu siguiente paso con claridad",
        desc: "Spot, futuros, holding o solo educación por ahora: identifica qué encaja con tu experiencia y tolerancia al riesgo.",
        ...
        >
            <div style={{ maxWidth: "1100px", margin: "0 auto", textAlign: "center" }}>
                ...
                <h2 className="section-title">
                    Aprende cripto con criterio, no por impulso
                </h2>
